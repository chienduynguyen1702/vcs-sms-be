...
func setupGroupUserRole(rg *gin.RouterGroup) {
	...
	// POST /users
	rg.POST("/users", middleware.RequiredAuth, userController.CreateUser)

	// PUT /users/:user_id
	rg.PUT("/users/:user_id", middleware.RequiredAuth, userController.UpdateUser)

	// DELETE /users/:user_id
	rg.PATCH("/users/:user_id/archive", middleware.RequiredAuth, userController.ArchiveUser)
	rg.PATCH("/users/:user_id/unarchive", middleware.RequiredAuth, userController.UnarchiveUser)
